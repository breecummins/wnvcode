...
plot(results.xmfinalpos,results.ymfinalpos,'r.','MarkerSize',12)
...
if p.saveGraph;
	...
	saveas(gcf,['/scratch03/bcummins/mydata/wnv/AlterAlpha/frames/',framename,'_time',int2str(t),'.png'],'png')
end
