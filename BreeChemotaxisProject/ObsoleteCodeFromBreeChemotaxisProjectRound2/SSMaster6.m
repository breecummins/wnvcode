...
fixedvars.L=1;				% nondimensional length
Ng=125;				% number of grid points on each side of the domain
fixedvars.h = fixedvars.L/Ng;			% separation between grid points
[fixedvars.xg,fixedvars.yg] = meshgrid( 0 : fixedvars.h : fixedvars.L-fixedvars.h/2 );  % discretized domain
fixedvars.tGraph=0; %don't plot pictures
fixedvars.Tf = 125;
fixedvars.dt=1.e-2; 			% dimensionless time step
