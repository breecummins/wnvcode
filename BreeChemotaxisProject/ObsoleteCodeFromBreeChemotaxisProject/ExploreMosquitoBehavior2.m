...
maxDmem = fixedvars.maxG *ruleparams.minspdmem*fixedvars.dt; %max conc change that mosquito is likely to see (slow flight near max gradient)
maxDfixed = fixedvars.maxG *ruleparams.spdfixed*fixedvars.dt; %max conc change that mosquito could see with fixed flight speed
maxDconc = fixedvars.maxG *0.5*(ruleparams.maxspdconc + ruleparams.minspdconc)*fixedvars.dt; %max conc change that mosquito is likely to see (slow flight near max conc means close to average flight around max gradient for this problem)
