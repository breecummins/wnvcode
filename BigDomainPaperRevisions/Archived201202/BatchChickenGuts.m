function [ xm, ym, results ] = BatchChickenGuts( p, xm0, ym0, tm0, mem0, xc, yc, r1all, r2all, Cmem0, angmem0, modevec0 )
    ...
    for t = 0 : p.dt : p.Tf
        ...
        if (mod(t,p.tMosq) < p.dt/2);
            if ~isempty(xm);
                [xm,ym,mem,results,tstart,Cmem,angmem,modevec] = MoveMosquitoes(xm,ym,mem,results,xc,yc,U,V,C,Cmem,angmem,p,t,tstart,modevec);
            end
