...
all_descriptions = { 'Grad: pick dir & spd','Grad: pick dir, spd fixed','Grad: pick dir, spd rand','Conc: dir mem,  pick spd', 'Conc: dir mem, spd mem', 'Conc: dir mem, spd fixed', 'Conc: dir mem, spd rand','Conc: dir rand, pick spd','Diffusion'};
...
fname='~/WNVThirdRuns/MemoryRules';
...
fixedvars.Methods=4:7;
fixedvars.descriptions={all_descriptions{fixedvars.Methods}};
