function D = DiffuseC_implicit_exact_grad(C, dt, h, nu, tolerance,l_bounds,r_bounds,t_bounds,b_bounds,t);
  ...
  Dp = implicit_RHS_exact_grad(D,dt,h,nu,dims(1),dims(2),l_bounds,r_bounds,t_bounds,b_bounds,t);
  D = Dp;
